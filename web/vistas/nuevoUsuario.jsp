        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                <a href="#" class="logo">
                    ...
                    <span class="logo-lg"><b>SCWBN </b></span>
                </a>
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="#"><i class="fa fa-archive"></i>Junta Administrativa</a></li>
                                <li><a href="#"><i class="fa fa-tags"></i>Inmueble</a></li>         
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="#"><i class="fa fa-tags"></i>Administrar Eventos</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <input id="nombre" type="text" class="form-control" placeholder="Ejem: Elkin" name="txtNombre" maxlength="10"
                                               value="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <input id="nombre" type="password" class="form-control" placeholder="Ejem: 12$rwew" name="txtClave" maxlength="10"
                                               value="">
                                    </div>
                                </div>
                                <div class="form-group">
