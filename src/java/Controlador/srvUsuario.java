...
public class srvUsuario extends HttpServlet {
    ...
    private void verificar(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        } else if (usuario != null && usuario.getCargo().getNombreCargo().equals("PROPIETARIO")) {
            sesion = request.getSession();
            sesion.setAttribute("propietario", usuario);
            this.getServletConfig().getServletContext().getRequestDispatcher("/vistas/formPropietario.jsp").forward(request, response);
        } else {
